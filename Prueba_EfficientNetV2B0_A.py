...
def EfficientNetV2_B0(numero_clases, tamano, pesos):
...
if __name__ == "__main__":
    ...
    for iteration in np.arange(29, 32):
        fold = 1
        ...
        for train_indices, test_indices in kf.split(train_df, train_df['Label']):
            ...
            Epocas = 20
            modelo = EfficientNetV2_B0(5, (493, 493, 3), pesos)
            ...
            fold += 1
        results_df.to_csv('/home/Pruebas_Exhaustivas/EfficientNetV2B0/cross_validation_history_' + 'EfficientNetV2_B0_SP29-31extra.csv', index=False)
        classification_metrics.to_csv('/home/Pruebas_Exhaustivas/EfficientNetV2B0/cross_validation_metrics_' + 'EfficientNetV2_B0_SP29-31extra.csv', index=False)