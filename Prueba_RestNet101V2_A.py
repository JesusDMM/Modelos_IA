...
def ResNet101V2(numero_clases, tamano, pesos):
...
if __name__ == "__main__":
    ...
    pesos = 'imagenet'
    input =  tf.keras.applications.resnet_v2.preprocess_input
    image_df = ruta_df()
    ...
    for iteration in np.arange(31) + 1:
        ...
        for train_indices, test_indices in kf.split(train_df, train_df['Label']):
            ...
            Epocas = 20
            modelo = ResNet101V2(5, (493, 493, 3), pesos)
            ...
            fold += 1
        results_df.to_csv('/home/Pruebas_Exhaustivas/ResNet101V2/cross_validation_history_' + 'RestNet101V2_A.csv', index=False)
        classification_metrics.to_csv('/home/Pruebas_Exhaustivas/ResNet101V2/cross_validation_metrics_' + 'RestNet101V2_A.csv', index=False)