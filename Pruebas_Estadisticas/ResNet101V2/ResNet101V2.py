...
def unir_csv (ruta, nombre):
    ...
    for archivo in os.listdir(directorio):
        if archivo.startswith("cross_validation_history") and archivo.endswith("SP.csv"):
...
#csv = '/home/jesus/SugarCane/Pruebas_Estadisticas/ResNet101V2/Graficas_ResNet101V2/Data/History_SP_ResNet101V2.csv'
#nombre_grafico = 'Loss'
...
for metrica in metricas:
    nombre = 'Metrica_' + metrica + '_sp.png'
